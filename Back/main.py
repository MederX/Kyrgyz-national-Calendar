...
ANIMALS_KY = ['Чычкан', 'Уй', 'Жолборс', 'Коён', 'Балык', 'Жылан', 'Жылкы', 'Кой', 'Маймыл', 'Тоок', 'Ит', 'Доңуз']
ANIMALS_RU = ['Мышь', 'Корова', 'Тигр', 'Заяц', 'Рыба', 'Змея', 'Лошадь', 'Овца', 'Обезьяна', 'Петух', 'Собака', 'Кабан']
