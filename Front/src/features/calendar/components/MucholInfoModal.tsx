            ...
            <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
                ...
                <div className={styles.content}>
                    <p>
                        {language === 'ky' ? (
                            <>
                                <strong>Мүчөл жылы</strong> - бул Чыгыш календары боюнча эсептелген 12 жылдык цикл. Ар бир жыл белгилүү бир жаныбар менен аталып, ошол жаныбардын “мүнөзү” жылга жана ошол жылы төрөлгөн адамдарга тиешелүү деп эсептелет.
                                <br /><br />
